...
_SCRIPT = REPO / "skills" / "discord-voice" / "scripts" / "share-screen-modal.py"
if not _SCRIPT.exists():
    print(f"SKIP: {_SCRIPT.name} not present in this tree (moved to standalone skill in #1115)")
    sys.exit(0)

_spec = importlib.util.spec_from_file_location("share_screen_modal", _SCRIPT)
